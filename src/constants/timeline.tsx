...
export const TIMELINE_LIST: Array<TimelineItemProps> = [
  {
    ...
    companyEnd: 'Present',
    descriptionTexts: [
      'The place where I am currently working as a Software Engineer on the Tech Innovation Team, leading Frontend development and architecting a new frontend framework and UI library',
